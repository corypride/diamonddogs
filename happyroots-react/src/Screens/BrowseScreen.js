      ...
      <div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between'}}>
          {dataList?.map((species) => (
            <div key={species.id} style={{ width: '33%', marginBottom: '20px', boxSizing: 'border-box', border: '5px solid #ccd', borderRadius: '4vh', backgroundColor: '#cce' }}>
              <h4>{species.common_name}</h4>
              <img src={species.default_image?.regular_url || species.default_image?.orignal_url || species.default_image?.medium_url || species.default_image?.small_url || species.default_image?.thumbnail || imgLink } alt={species.common_name} style={{ width: '100%', borderRadius: '8px' }} />
